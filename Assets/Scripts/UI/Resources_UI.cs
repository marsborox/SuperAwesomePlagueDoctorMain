...
public class Resources_UI : UI
{
    ...
    private void UpdateHealth()
    {
        ...
        */
        ...
        _healthText.text = player.ReturnHealthCurrent() + " / " + player.ReturnHealthMax();
        _healthBarImage.fillAmount = player.ReturnHealthCurrent() / player.ReturnHealthMax();
        _scoreText.text = "Score: " + player.ReturnScoreAmount().ToString();
        _damageText.text = "Damage: " + player.ReturnDamageAmount().ToString();
        _attackIntervalText.text = "Atk Interval: " + player.ReturnAttackIntervalAmount().ToString();
    }
